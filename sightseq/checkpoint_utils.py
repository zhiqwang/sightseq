...
def load_checkpoint(args, trainer):
    ...
    if extra_state is not None and not args.reset_dataloader:
        ...
        epoch_itr = trainer.get_train_iterator(epoch=itr_state['epoch'], transform=trainer.transform)
        epoch_itr.load_state_dict(itr_state)
    else:
        epoch_itr = trainer.get_train_iterator(epoch=0, transform=trainer.transform)
