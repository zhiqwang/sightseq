...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        small_inputs=True, groups=1, width_per_group=64,
        ...
        self.conv1 = nn.Conv2d(3, self.inplanes, kernel_size=kernel_size, stride=stride, padding=padding,
                               bias=False)
        self.bn1 = norm_layer(self.inplanes)
        self.relu = nn.ReLU(inplace=True)
        # NOTE: CIFAR10 does not contain maxpool layer
